...
//struct i2c_m_sync_desc wiremag;
...
void wire_init(void)
{
	...
	//i2c_m_sync_init(&wiremag, SERCOM3);
	wire_PORT_init();
}
...
void system_init(void)
{
	...
	// Set pin direction to output
	gpio_set_pin_direction(SS_MAG, GPIO_DIRECTION_OUT);

	gpio_set_pin_level(SS_MAG,
	                   // <y> Initial level
	                   // <id> pad_initial_level
	                   // <false"> Low
	                   // <true"> High
	...
	gpio_set_pin_function(SS_MAG, GPIO_PIN_FUNCTION_OFF);

	// GPIO on PA19

	// Set pin direction to output
	gpio_set_pin_direction(SS_XL, GPIO_DIRECTION_OUT);

	gpio_set_pin_level(SS_XL,
	                   // <y> Initial level
	                   // <id> pad_initial_level
	                   // <false"> Low
	                   // <true"> High
	...
	gpio_set_pin_function(SS_XL, GPIO_PIN_FUNCTION_OFF);
	// GPIO on PA17
